...
console.log(token)
if(e.msg.includes("/我的二次元")){
let url3 = `http://ovooa.caonm.net/API/Ser/?name=${e.sender.nickname}&type=text`
let res = await fetch(url3)
res = await res.text()
re = res.replace(`${e.sender.nickname}`,"").replace("的","").replace(/。/g,"").replace(/，/g,",").replace("惊天巨乳","身材苗条")
}
if(e.msg.includes("/他的二次元")){
let name = e.message.filter(item => item.type == 'at')?.map(item => item?.text)
console.log(e.message)
let url3 = `http://ovooa.caonm.net/API/Ser/?name=${name}&type=text`
let res = await fetch(url3)
res = await res.text()
re = res.replace(`${name}`,"").replace("的","").replace(/。/g,"").replace(/，/g,",").replace("惊天巨乳","身材苗条")
}
console.log(re)
...
//console.log(img)
var Data = atob(img);
fs.writeFileSync("./resources/ht/t.jpg", Data,
"binary", );
let at = segment.at(e.user_id)
let tu = segment.image("./resources/ht/t.jpg")
let mn = ["以下是他的二次元形象:",re,"\n",tu]
e.reply(mn)
}
async ey(e){
if (fs.existsSync(dirpath + "/" + "data.json")){
...
let token = await a.data.token
console.log(token)
if(e.msg.includes("/我的三次元")){
let url3 = `http://ovooa.caonm.net/API/Ser/?name=${e.sender.nickname}&type=text`
let res = await fetch(url3)
res = await res.text()
rep = res.replace(`${e.sender.nickname}`,"").replace("的","").replace(/。/g,"").replace(/，/g,",").replace(/二/g,"三")
console.log(re)
}
if(e.msg.includes("/他的三次元")){
let name = e.message.filter(item => item.type == 'at')?.map(item => item?.text)
console.log(e.message)
let url3 = `http://ovooa.caonm.net/API/Ser/?name=${name}&type=text`
let res = await fetch(url3)
res = await res.text()
rep = res.replace(`${name}`,"").replace("的","").replace(/。/g,"").replace(/，/g,",").replace(/二/g,"三")
}
console.log(re)
let url2 = "https://flagopen.baai.ac.cn/flagStudio/v1/text2img"
let b = await fetch(url2,{
...
//console.log(img)
var Data = atob(img);
fs.writeFileSync("./resources/ht/tu.jpg", Data,
"binary", );
let at = segment.at(e.user_id)
let tu = segment.image("./resources/ht/tu.jpg")
let mn = ["以下是他的三次元形象:",rep,"\n",tu]
e.reply(mn)
}
async txkey(e){
...
//console.log(img)
var Data = atob(img);
fs.writeFileSync("./resources/ht/ht.jpg", Data,
"binary", );
e.reply(segment.image("./resources/ht/ht.jpg"))
}
