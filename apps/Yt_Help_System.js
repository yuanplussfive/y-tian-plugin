...
async function getModelScreen(models, type, e) {
  ...
  const logoRules = [
    ...
    { prefix: ['imagen-', 'gemini', 'gemma', 'learnlm', 'google'], file: 'gemini.jpg' },
    ...
    { prefix: ['anything-', 'noobxl-', 'noobai', 'wai-', 'anishadow-', 'liblib-'], file: 'Noob.png' },
    { prefix: ['kusa-', 'animagine-', '-pony', 'pixel-', 'illustrious-', 'sd-', 'sd3', 'stable-diffusion', 'sdxl'], file: 'sd.png' },
