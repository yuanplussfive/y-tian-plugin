...
const sessionStorage = {sc: '22', length: 1}
...
export async function get_xs_xt(url, data, a1) {
    document.cookie = `a1=${a1};`
    return await window._webmsxyw(url, data)
}

// log(await get_xs_xt("/api/sns/web/v2/comment/sub/page?note_id=66ae1609000000000600c3ae&root_comment_id=66ae2f8300000000260039fb&num=10&cursor=66ae685b000000001b013669&image_formats=jpg,webp,avif&top_comment_id=", undefined, cookie_a1))
// const data = {
//     "source_note_id": 123,
