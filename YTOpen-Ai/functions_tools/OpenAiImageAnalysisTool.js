 ...
 */
export class OpenAiImageAnalysisTool extends AbstractTool {
    constructor() {
        super();
        this.name = 'OpenAiimageAnalysisTool';
        this.description = '使用OpenAi的ChatGPT进行图像分析, 当用户需要分析、处理、识别图片内容，或者询问图片相关信息时使用此工具。支持多图片分析，可提取图片中的文字信息并进行理解分析。注意：所有图片URL必须保持完整原始形式，不得修改或简化URL参数。';
        this.parameters = {
            type: "object",
            properties: {
                prompt: {
