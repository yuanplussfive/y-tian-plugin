...
/**
 * 调用Cursor Claude API进行对话，支持URL轮询和负载均衡。
 *
 * @param {Array<object>} messages 对话消息数组，例如：[{ role: 'user', content: '你好' }]。
 * @param {string} model 使用的模型名称。
 * @param {string[]} [urls=['https://cursorclaude.deno.dev/v1/chat/completions']]
...
export const cursor = async (
    ...
    model,
    urls = [
        'https://cursorclaude.deno.dev/v1/chat/completions',
        'https://cursorclaude2.deno.dev/v1/chat/completions',
        'https://cursorclaude3.deno.dev/v1/chat/completions',
        'https://cursorclaude4.deno.dev/v1/chat/completions'
    ]
) => {
